                ...
                for fit_path in [True, False]:
                    for verbose in [True, False]:
                        for positive in [True, False]:
                            ...
                            clf = ll(precompute=precompute, fit_intercept = fit_intercept, normalize = normalize, 
                                copy_X = copy_X, fit_path = fit_path, verbose = verbose, positive = positive)
                            clf1 = ll(precompute=precompute, fit_intercept = fit_intercept, normalize = normalize, 
                                copy_X = copy_X, fit_path = fit_path, verbose = verbose, positive = positive)
